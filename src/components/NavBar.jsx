...
const NavBar = () => {
    ...
    return (
        <>
         <div className='sticky top-0 w-full h-24 bg-black text-white z-20'>
            ...
            <div className={`w-full bg-black text-white fixed z-10 left-0 h-fit py-12 md:hidden flex justify-center text-center text-2xl duration-500 ${nav ? 'top-24 rounded-b-2xl opacity-95' : 'top-[-100%]' }`}>
                <ul >
                {links.map(({id, link}) =>(
                    <li 
                        key={id} 
