...
export const timeline = [
    ...
    },
    {
        ...
        location: 'Remote',
        message: [`Create reusable React component.`, `Optimizing web pages for mobile view.`, `Customize Material UI to follow brand styling guidelines`, `Follow tight deadlines and track progress using issue tracking systems`, `Debug, document, and fix client-facing bugs.`]
    },
];